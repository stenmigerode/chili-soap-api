...
class ResourceItemAddFromURLWithModificationDate
{
     ...
     * @access public
     */
    public function __construct($apiKey, $resourceName, $newName, $folderPath, $url, $login, $pw, $reuseExisting, $previewFileURL, $previewExtension, $isPermanentPreview, $modificationDate)
    {
      $this->apiKey = $apiKey;
